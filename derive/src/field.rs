...
impl Field {
    ...
    pub fn decode_match_arm(
        ...
        match *self {
            ...
            Field::UnknownFields(ref f) => {
                f.decode_match_arm(matched_tag, field, wire_type, msg_buf, remaining, known_tags)
            }
        }
    }
    ...
    pub fn decode_raw_block(
        ...
        match *self {
            ...
            Field::UnknownFields(ref f) => {
                f.decode_raw_block(matched_tag, field, wire_type, msg_buf, remaining, known_tags)
            }
        }
    }
